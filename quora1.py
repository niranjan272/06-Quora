...
train = pd.read_csv("C:\\Users\\Niranjan\\Desktop\\train.csv")
train[ 'R' ] = train.apply( word_match_share, axis=1, raw=True )
print( train.head() ) 

test = pd.read_csv("C:\\Users\\Niranjan\\Desktop\\test.csv", index_col=False )
...
test[ ['test_id','is_duplicate'] ].to_csv("F:\\Study\\OneDrive - The University of Texas at Dallas\\02 Study\\06 Quora\\count_words_benchmark.csv", header=True, index=False)
